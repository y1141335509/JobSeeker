                  ...
                  <div className="text-center">
                    ...
                    {user?.zodiacSign && (
                      <div className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-purple-100 text-purple-800">
                        ...
                        <span className="capitalize">{user.zodiacSign}</span>
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Your zodiac sign helps us provide personalized career guidance.
                      </p>
                    </div>
                    ...
                    <div className="pt-6 border-t border-gray-200">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-500">
                              Receive your daily career horoscope via email
                            </p>
                          </div>
                          <input
                            type="checkbox"
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <label className="text-sm font-medium text-gray-700">
                              Weekly tarot insights
                            </label>
                            <p className="text-xs text-gray-500">
                              Receive weekly career guidance through tarot
                            </p>
                          </div>
                          <input
                            type="checkbox"
